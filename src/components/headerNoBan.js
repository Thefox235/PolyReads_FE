          ...
          <div className="nav">
            ...
            <div className=" justify-content-between align-items-start w-100 custom-menu ">
              ...
              <nav className="d-flex align-items-center custom-nav">
                ...
                <>
                  {user ? (
                    <li className="user-dropdown-menu">
                      <button className="user-dropdown-btn">{user.name}</button>
                      <div className="user-dropdown-content">
                        {user.role === "1" && (
                          <>
                            <a href="/dashboard">
                              <span style={{ color: "rgb(160, 15, 15)" }}>
                                &gt;
                              </span>{" "}
                              Dashboard
                            </a>
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      style={{ fontSize: "3.5rem", fill: "#917FB3" }}
                      viewBox="0 0 16 16"
                    >
            ...
            >
              <div className="d-flex align-items-center gap-3 menu">
                <div className="dropdown">
                  <i className="bi bi-list" />
                  <button className="border-0 dropdown-btn">
                    Tất cả thể loại
                  </button>
                  <div className="dropdown-content">
                    <a href="#">
                    ...
                    <a href="">
                      <span style={{ color: "#a00f0f" }}>&gt;</span>Art,
                      Photography &amp; Design
                    </a>
                    <a href="">
                      <span style={{ color: "#a00f0f" }}>&gt;</span>Ngôn ngữ,
                      Sách tham khảo
                    </a>
                    <a href="">
                      <span style={{ color: "#a00f0f" }}>&gt;</span>Sách giáo
                      khoa
                    </a>
                    <a href="">
                      <span style={{ color: "#a00f0f" }}>&gt;</span>Sách về Việt
                      Nam
                    </a>
                  </div>
                </div>
